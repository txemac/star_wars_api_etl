...
def test_sort_characters_taller_ok(
    ...
    result = start_wars_repository.sort_characters_taller(characters=list_characters)
...
def test_sort_characters_taller_with_limit(
    ...
    result = start_wars_repository.sort_characters_taller(characters=list_characters, limit=2)
